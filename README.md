...
| 2 | **进程扫描** | 每60秒扫描 wps.exe / et.exe / wpp.exe 等6个进程 |
...
# 运行
dotnet run --project OfficeGuardian
```
...
├── Services/
│   ├── ProcessMonitorService.cs  # 进程扫描（每60秒）
...
```
┌─────────────────────────────────────────────────┐
│  🛡️ OfficeGuardian    运行中...   告警: 0       │
├──────────┬──────────┬──────────┬────────────────┤
│ 💾 WPS 内存 │ ⚡ CPU占用 │ 🧵 线程数 │ 🔧 句柄数   │
├──────────┴──────────┴──────────┴────────────────┤
│  📈 内存趋势 (MB)        │  📋 操作面板          │
│  ━━━━━━━━━━━━━━━━        │                       │
│                          │  📊 每日报告          │
